...
router.put('/user_courses', function(req, res){
	User.addCourseAttending(req.body.userId, req.body.courseId);
	res.redirect('/');
});
...
//Route for the courses the user is administrating, then redirects to dashboard/home
router.put('/user_courses_admin', function(req, res){
	User.addCourseAdministrating(req.body.userId, req.body.courseId);
	res.redirect('/');
});
